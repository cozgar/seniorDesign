...
from ipear.views import (login_view, register_view, edit_view, logout_view, home, dispatch_settings_view, profile_view, staff_view, edit_user_profile_view, settings_view, edit_user_mike, edit_user_mike_edit, more_info_view)
...
urlpatterns = [
    ...
    url(r'^more_info/$', more_info_view, name='more_info'),
